...
//  LoginTest
//
//  Created by Leonid Mesentsev on 24/10/22.
//
...
private let UseOperationPrompt = String(kSecUseAuthenticationContext)
...
@available(iOS 9.0, OSX 10.11, watchOS 2.0, tvOS 9.0, *)
private let UseAuthenticationUIAllow = String(kSecUseAuthenticationUI)

@available(iOS 9.0, OSX 10.11, watchOS 2.0, tvOS 9.0, *)
private let UseAuthenticationUIFail = String(kSecUseAuthenticationContext)
